...
- [ ] Task 1: Add Meta Tags to Property Template (AC: #1)
  - [ ] Subtask 1.1: Read property data in src/property.html and extract title components
  - [ ] Subtask 1.2: Generate dynamic title tag in page head: "[Price] [Beds]bed [Address] | PPIProperties"
  - [ ] Subtask 1.3: Generate dynamic meta description (155-160 chars): "[Address] — [Beds] bed property in [Location]. [Brief description]"
  - [ ] Subtask 1.4: Add meta keywords tag with property location and bedroom count
  - [ ] Subtask 1.5: Test title/description generation with multiple properties to verify uniqueness

- [ ] Task 2: Implement Open Graph Tags (AC: #2)
  - [ ] Subtask 2.1: Add og:title, og:description, og:image meta tags
  - [ ] Subtask 2.2: Set og:url to property detail page URL
  - [ ] Subtask 2.3: Set og:type to "website"
  - [ ] Subtask 2.4: Add twitter:card tag
  - [ ] Subtask 2.5: Test social sharing preview (use Facebook/Twitter sharing debuggers)

- [ ] Task 3: Add JSON-LD Schema.org Structured Data (AC: #3)
  - [ ] Subtask 3.1: Create Property schema JSON-LD object with all required fields
  - [ ] Subtask 3.2: Add agent information (Person/Organization with contact details)
  - [ ] Subtask 3.3: Format JSON-LD correctly and inject into page head
  - [ ] Subtask 3.4: Validate structured data with Schema.org validator
  - [ ] Subtask 3.5: Test with Google's Rich Results Test tool

- [ ] Task 4: Add Canonical Tags and Language Meta Tags (AC: #4)
  - [ ] Subtask 4.1: Add canonical link tag pointing to property page URL
  - [ ] Subtask 4.2: Add language meta tag (lang attribute and language meta tag)
  - [ ] Subtask 4.3: Ensure no noindex tags are present (allow indexing)

- [ ] Task 5: Build and Verify Implementation (AC: All)
  - [ ] Subtask 5.1: Run `npm run build` and verify all property pages generate without errors
  - [ ] Subtask 5.2: Inspect generated HTML files to verify meta tags are present and unique
  - [ ] Subtask 5.3: Validate JSON-LD with Schema.org validator for 2-3 property pages
  - [ ] Subtask 5.4: Test with Google Rich Results Test tool
  - [ ] Subtask 5.5: Verify no build warnings or errors in console output
...
- `src/property.html` - Add meta tags, OG tags, and JSON-LD structured data to page head

Files to be created:
- None (all changes within existing template)
